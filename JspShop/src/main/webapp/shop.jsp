...
%>
<%
	//상품DAO는 트랜잭션 때문에 SqlSession을 멤버변수로 두고 setter로 주입받기를 기다리고 있음
	SqlSession sqlSession = mybatisConfig.getSqlSession();
	productDAO.setSqlSession(sqlSession); //SqlSession주입!
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            %>
                                ...
                                <div class="product__item__text">
                                    ...
                                    <div class="product__price"><%= product.getDiscount() %></div>
                                </div>
                            </div>
                        </div>
                        <%} %>
